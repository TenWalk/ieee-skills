...
description: >-
  ...
  citations", "参考文献改成 IEEE 格式", "整理引用", or asks how in-text numbered citations and the
  reference list should look for an IEEE journal. Also covers Index Terms and EDICS selection
  ("选 EDICS", "Index Terms 怎么写"). Never fabricate DOIs, page numbers, volumes, EDICS codes, or
  any bibliographic field — flag missing metadata instead.
version: 0.2.0
author: WT — based on IEEE Reference Guide conventions and the IEEEtran/IEEEtran.bst workflow
---
